...
<div id="mainContainer">
  <div id="contents">
    ...
    <?php if (is_user_logged_in()) : ?>
      ...
      $page_id = get_the_ID();
      ?>
      <?php if (have_rows('renraku', $page_id)) : ?>
        <secton id="renraku">
          <h2 class="title-b">各種連絡票</h2>
          <div class="download">
            <?php while (have_rows('renraku', $page_id)) : the_row(); ?>
              <section>
      ...
      <?php endif; ?>
      <?php if (have_rows('kyotei', $page_id)) : ?>
        <secton id="kyotei">
          <h2 class="title-b">書式集</h2>
          <div class="download">
            <?php while (have_rows('kyotei', $page_id)) : the_row(); ?>
              <section>
                <h3><a href="<?php the_sub_field('file'); ?>" target="_blank"><?php the_sub_field('name'); ?><img src="/cms/wp-content/themes/officeuemura/img/icon_<?php the_sub_field('type'); ?>.png" class="icon" alt="<?php the_sub_field('type'); ?>"></a></h3>
                <p><?php the_sub_field('caption'); ?></p>
              </section>
